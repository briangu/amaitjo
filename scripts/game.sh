java -ea -Xmx2048m -cp lib/ants-api.jar:lib/ants-server.jar:ants-impl/build/libs/ants-impl.jar:target/amaitjo-1.0.0-jar-with-dependencies.jar org/linkedin/contest/ants/server/AntServer -B -p1 amaitjo.brains.PassAnt -p2 amaitjo.brains.bt.Ozzy
